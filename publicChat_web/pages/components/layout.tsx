...
export default function Layout() {
    ...
    function onLogin(params: { user: any; pic: any; }) {
        ...
        // const fullUrl = `wss://127.0.0.1:34001/web-socket?data=${encodeURIComponent(jsonStr)}`;
        const fullUrl = `wss://publicchat_api.luocheng.fun/web-socket?data=${encodeURIComponent(jsonStr)}`;
        setUrl(fullUrl);
